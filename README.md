...
# Team Members(Roles): Allison Ly (Lead Programmer) , Elena Koleva (Project Manager) , Gianna Rodriguez (Quality Assurance Tester) , Kayla To (Technical Writer)
...
What users can expect when they run it: When users hit run, they are expected to type their input to interact with the program.
